...
public class ReleaseImpactController {
    ...
    public ReleaseImpactController(
            ReleaseImpactService service) {
        this.service = service;
    }

    @PostMapping("/analyze")
    public ResponseEntity<ReleaseImpactResult> analyze(
            @RequestBody ReleaseImpactRequest request) {
    ...
    @GetMapping("/latest")
    public ResponseEntity<ReleaseImpactResult> latest(
    ...
    @GetMapping("/history")
    public ResponseEntity<List<ReleaseImpactResult>> history(
