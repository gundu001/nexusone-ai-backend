...
@RestControllerAdvice public class KnowledgeFabricExceptionHandler{
 @ExceptionHandler(KnowledgeNotFoundException.class) ResponseEntity<Map<String,Object>> notFound(KnowledgeNotFoundException e){return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of("timestamp",LocalDateTime.now(),"message",e.getMessage()));}
